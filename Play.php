<?php
    ...
    namespace IdnoPlugins\Play {
        ...
        class Play extends \Idno\Common\Entity
        {
            ...
            function getGameURL()
            {
                if (!empty($this->gameURL)) return $this->gameURL;
            ...
            function getURL()
            {
                ...
                if (!$this->getSlug() && ($this->getID())) {
                    return \Idno\Core\site()->config()->url . 'play/' . $this->getID() . '/' . $this->getPrettyURLTitle();
                } else {
            ...
            function getMetadataForFeed()
            {
                return array(
                    ...
                    'game-url' => $this->getGameURL(),
                    'duration' => $this->getDuration()
                );
            }

            /**
             * play objects have type 'play'
             * @return 'play'
             */
            ...
            function saveDataFromInput()
            {
                ...
                if (!empty($body)) {
                    ...
                    $this->gameURL  = \Idno\Core\site()->currentPage()->getInput('gameURL');
